        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-10 px-4 py-4 lg:px-8">
                    ...
                    <div className="mb-4">
                        <label className="mb-1 block text-sm font-medium text-gray-700">{t('ui.settings.profile.select_user')}</label>
                        <UserCombobox users={users} onSelectUser={(userId) => setSelectedUserId(userId)} />
                    </div>
