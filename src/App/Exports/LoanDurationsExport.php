...
class LoanDurationsExport implements FromCollection, WithMapping, WithHeadings, WithStyles, WithEvents, ShouldAutoSize, WithStrictNullComparison
{
    ...
    {
        $this->loans = Loan::whereNotNull('end_loan')->get();
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $average = $this->loans->map(function ($loan) {
                    $start = Carbon::parse($loan->start_loan)->startOfDay();
                    $end = Carbon::parse($loan->end_loan)->startOfDay();
